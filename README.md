...
The old version of _When_ itself is currently being converted to a frontend wrapper for **whenever**: see [When: next generation](https://github.com/almostearthling/when-command/tree/next-generation) for more details.
