...
embedded in **whenever**. Also, the embedded *Lua* interpreter is enriched with several utility
functions, that are explained in detail in the dedicated `section <_65-lua-enhancements>`__.
...
More details *Lua* in **whenever** can be found in the dedicated `chapter <_65-lua>`__.
