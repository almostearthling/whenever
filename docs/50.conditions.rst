...
.. tip::
   ...
   The `variables_to_set` entry can be used to set _any_ global variable in the embedded
   ...
   _frontend_ may provide extra functionality to the Lua interpreter by explicitly setting the
